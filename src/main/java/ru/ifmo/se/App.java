...
import ru.ifmo.se.models.comporators.MusicBandNumberOfParticipantsComparator;
...
public class App {
    public static void main(String[] args) {
        ...
        commandManager.register("add_if_max", new AddIfMaxCommand(collectionManager, new MusicBandNumberOfParticipantsComparator()));
